...
RcppExport SEXP _transportMatching_calibRaking(SEXP XsSEXP, SEXP dSEXP, SEXP totalSEXP, SEXP qSEXP, SEXP max_iterSEXP, SEXP tolSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_transportMatching_calibRaking", (DL_FUNC) &_transportMatching_calibRaking, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_transportMatching(DllInfo *dll) {
